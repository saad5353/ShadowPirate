...
public class pirate {
    ...
    public pirate() {
        ...
        currX = 0;
        currY = 0;
        leftImage = new Image("res\\pirate\\pirateLeft.png");
        rigtImage = new Image("res\\pirate\\pirateRight.png");
        leftImageInvincible = new Image("res\\pirate\\pirateHitLeft.png");
        rigtImageInvincible = new Image("res\\pirate\\pirateHitRight.png");
